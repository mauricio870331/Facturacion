...
public class EmpresasDAO {
    ...
    public List<Empresas> getEmpresasList() throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                Empresas v = new Empresas(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getBoolean(7), rs.getString(8), rs.getInt(9), rs.getBoolean(10), rs.getString(11), rs.getString(12), rs.getString(13));
                list.add(v);
            }
        } catch (Exception e) {
