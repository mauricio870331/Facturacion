...
public final class UsuariosApp {
    ...
    public String toString() {
        return "UsuariosApp{" + "idUsuario=" + idUsuario + ", tipoIdentiicacion=" + tipoIdentiicacion.getIdTipoIdentificacion() + ", vendedor=" + vendedor.getIdEmpresa() + ", rol=" + rol.getIdRol() + ", password=" + password + ", nombres=" + nombres + ", apellidos=" + apellidos + ", estadoUsuario=" + estadoUsuario + ", transacion=" + transacion + '}';
    }
