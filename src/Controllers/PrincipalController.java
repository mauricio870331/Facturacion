...
import App.AnularFacturas;
import App.GenerarPagos;
import App.GenerarRetencion;
import App.GetAnularFacturas;
import App.GetGenerarPagos;
import App.GetGenerarRetencion;
import App.GetModalClientes;
import App.GetPagosRealizados;
import App.GetPrincipal;
import App.GetReporteIngresos;
import App.GetTipoHospedaje;
import App.ModalActualizarHospedaje;
import App.ModalCambiarClave;
import App.ModalClientes;
import App.ModalItem;
import App.ModalNumeracion;
import App.ModalReporteFacturacion;
import App.ModalTarifasHospedaje;
import App.ModalVincularUsuarios;
import App.PagosRealizados;
import App.Principal;
import App.RegistrarHuesped;
import App.ReporteIngresos;
import App.ResolucionFacturacion;
import App.SelectTipoHospedaje;
import App.getModalActualizarHospedaje;
import App.getModalCambiarClave;
import App.getModalItem;
import App.getModalNumeracion;
import App.getModalReporteFacturacion;
import App.getModalResolucion;
import App.getModalTarifasHospedaje;
import App.getModalVincularUsuarios;
...
//        detalleFacturaItems.clear();
    ...
    public void cargarTablaFactura(String dato, boolean isfactura) throws SQLException {
        ...
        String Titulos[] = {Factura, "Valor", "Retenciones", "Abonos", "Creada", "Vence", "Saldo", "Estado"};
        modelo = new DefaultTableModel(null, Titulos) {
            @Override
            public boolean isCellEditable(int row, int column) {//para evitar que las celdas sean editables
                return false;
...
//        pr.tbFacturas.getColumnModel().getColumn(0).setMaxWidth(0);
//        pr.tbFacturas.getColumnModel().getColumn(0).setMinWidth(0);
//        pr.tbFacturas.getColumnModel().getColumn(0).setPreferredWidth(0);
        pr.tbFacturas.setModel(modelo);
